...
import TGIUKProj from "../assets/tgiuk_placeholder.webp";

export const projList = [
  {
    id: 1,
    title: "Wix to WordPress: HHA",
    ...
    brief:
      "https://the-dog-can-blog.hashnode.dev/project-experience-migrate-domain-and-rebuild-hampton-hill-association-website",
  },
  {
    id: 2,
